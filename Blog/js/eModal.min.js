...
(function (define) {
    define(['jquery'], function ($, root) {
        ...
        var defaultSettings = {
            ...
            labels: LABEL,
            loadingHtml: '<div class="modal-body text-center" ><span class="fa fa-circle-o-notch fa-spin fa-3x text-primary" style="color: #dd4814;"></span><h4>Carregando</h4> </div>',
            size: EMPTY,
            title: 'Attention'
        };
        ...
        function _getFooter(buttons) {
            ...
            if (buttons) {
                ...
                messageFotter.append('<button class="x btn btn-danger" data-dismiss=modal type=button>OK</button>');
            }
        ...
        function iframe(params, title) {
            var dfd = _createDeferred();
            var html = ('<div class=modal-body style="position: absolute;width: 100%;background-color: #FFF;height: 100%;">%1%</div>' +
                '<iframe class="embed-responsive-item" frameborder=0 src="%0%" style="width:100%;height:101vh;display:block;"/>')
